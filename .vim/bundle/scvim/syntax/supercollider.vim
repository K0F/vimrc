...
hi link scNumber Delimiter
hi link scSemicolon Delimiter

"Here I have defined my own syntax colors
"you can customize these however you like

hi scNumber cterm=none ctermfg=red guifg=cyan
hi scSemicolon cterm=bold ctermfg=red guifg=cyan

hi scObject	cterm=bold ctermfg=172 guifg=cyan
hi scLang	cterm=bold ctermfg=lightcyan guifg=lightcyan
"
hi scBinaryoperator	cterm=none ctermfg=gray guifg=brown
hi scUnaryoperator	 ctermfg=darkgray guifg=brown
"
hi scAoperator	cterm=bold ctermfg=red guifg=darkyellow
"hi scArate	cterm=bold ctermfg=180 guifg=darkyellow
"hi scKrate	cterm=bold ctermfg=180 guifg=darkyellow
"
"hi scSymbol	term=bold ctermfg=red guifg=red
"
"hi scString	term=bold ctermfg=darkred guifg=darkred
"
"hi scChar	cterm=bold ctermfg=lightred guifg=lightred
"
"hi scSpecialval	cterm=bold ctermfg=magenta guifg=magenta
"
hi scGlobVariable	cterm=bold ctermfg=yellow guifg=yellow
"
"hi scComment	term=bold ctermfg=darkblue guifg=darkblue
"
hi scVar	cterm=bold ctermfg=green guifg=green
hi scArg	cterm=bold ctermfg=green guifg=green
